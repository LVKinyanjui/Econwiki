...
def pinecone_upsert_async(embeddings: list[float], texts: list[str], index_name: str, namespace: str):
    """
...
async def main():
    ...
    pinecone_upsert_async([vect['embeddings']['embedding']['values'] for vect in embed_dict],
